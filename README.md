# sanity-gatsby-portfolio-error-test
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/b4zjs81u/settings/api) and create a token with read rights.
